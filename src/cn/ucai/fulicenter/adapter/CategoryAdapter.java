...
public class CategoryAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            holder.ivGroupThumb = (ImageView) convertView.findViewById(R.id.iv_category_group_thumb);
            holder.tvGroupName = (TextView) convertView.findViewById(R.id.tv_category_group_name);
            holder.ivIndicator = (ImageView) convertView.findViewById(R.id.iv_indicator_group);
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            holder.rlCategoryChild = (RelativeLayout) convertView.findViewById(R.id.layout_category_child);
            holder.tvCategoryChildName = (TextView) convertView.findViewById(R.id.tv_category_child_name);
            holder.ivCategoryChildImage = (ImageView) convertView.findViewById(R.id.iv_category_child_thumb);
            convertView.setTag(holder);
        } else {
        ...
        if (child != null) {
            ImageUtils.setChildCategoryImage(mContext,holder.ivCategoryChildImage,child.getImageUrl());
            holder.tvCategoryChildName.setText(child.getName());
            holder.rlCategoryChild.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    mContext.startActivity(new Intent(mContext, CategoryChildActivity.class)
                            .putExtra(I.CategoryChild.CAT_ID,child.getId())
                            .putExtra("childName",child.getName())
    ...
    class ChildViewHolder {
        RelativeLayout rlCategoryChild;
