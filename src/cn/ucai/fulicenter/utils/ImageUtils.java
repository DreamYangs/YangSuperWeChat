...
//	}
	...
	public static void getNewGoodsThumb(Context context, ImageView imageView, String thumb) {
	...
	public static void setGroupCategoryImage(Context context, ImageView imageView, String imageUrl) {
		String url = I.REQUEST_DOWNLOAD_CATEGORY_GROUP_IMAGE_URL + imageUrl;
		Picasso.with(context).load(url).placeholder(R.drawable.nopic).into(imageView);
	}
	public static void setChildCategoryImage(Context context,ImageView imageView,String imageUrl) {
