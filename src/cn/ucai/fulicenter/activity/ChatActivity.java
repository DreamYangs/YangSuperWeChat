...
public class ChatActivity extends BaseActivity implements OnClickListener, EMEventListener{
	...
	class UpdateMembersListener extends BroadcastReceiver {
	...
	UpdateMembersListener mReceiverListener;

	private void setUpdateMembersListener() {
		mReceiverListener = new UpdateMembersListener();
		IntentFilter filter = new IntentFilter("update_member_list");
		registerReceiver(mReceiverListener, filter);
	}
}
