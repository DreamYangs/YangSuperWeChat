...
public class DemoDBManager {
    ...
    synchronized public void saveUserAvatar(UserAvatar user) {
            ...
            values.put(UserDao.USER_COLUMN_NAME_NAME, user.getMUserName());
    ...
    synchronized public UserAvatar getUserAvatar(String userName) {
        ...
        Cursor cursor = db.rawQuery("select * from " + UserDao.USER_TABLE_NAME
                + " where "+UserDao.USER_COLUMN_NAME_NAME + "=?",new String[]{userName});
    ...
    synchronized public void updateUserNick(UserAvatar userAvatar) {
        ...
        if (db.isOpen()) {
            db.update(UserDao.USER_TABLE_NAME, values, UserDao.USER_COLUMN_NAME_NAME + " = ?",
                    new String[]{String.valueOf(userAvatar.getMUserName())});
        }
    }
}